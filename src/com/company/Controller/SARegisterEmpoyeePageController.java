...
public class SARegisterEmpoyeePageController implements Initializable {
    ...
    public static Stage employeeListStage;
    public static boolean employeeListIsOpen=false;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        closeBTN.setOnAction(e -> {
            ...
            int index=SuperAdminPageController.SAPageTPfake.getTabs().indexOf(SuperAdminPageController.employeeRegisterTab);
            removeTabInTabPane.removeTab( SuperAdminPageController.SAPageTPfake, index);

            SuperAdminPageController.employeeRegisterTabIsOpen=false;

            //close list
            if (employeeListIsOpen)
            {
                employeeListStage.close();
                employeeListIsOpen=false;
        ...
        listBTN.setOnAction(e -> {
            ...
            FXMLLoader loader=new FXMLLoader(Main.class.getResource("View/SAEmployeeListPage.fxml"));
            try {
                loader.load();
            } catch (IOException ex) {
                ex.printStackTrace();
            ...
            employeeListStage=new Stage(StageStyle.UNDECORATED);
            employeeListStage.setScene(new Scene(loader.getRoot()));
            employeeListStage.show();


            warningLBL.setText("");
            employeeListIsOpen=true;
        });
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        Employee newEmployee=new Employee(idTF.getText(),nameTF.getText(),lastnameTF.getText(),usernameTF.getText(),
                                passwordTF.getText(),phoneNumberTF.getText(),emailAddressTF.getText(),salaryTF.getText(),addressTF.getText());
